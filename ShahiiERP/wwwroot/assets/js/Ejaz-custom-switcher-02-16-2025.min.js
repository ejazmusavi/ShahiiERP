...
(function () {
    ...
    if (localStorage.getItem("ynexgridheaderfixed") == true || localStorage.getItem("ynexgridheaderfixed") == 'true') {
        document.querySelector("html").setAttribute("data-grid-header-position", "fixed") 
    }
    else{
        document.querySelector("html").setAttribute("data-grid-header-position", "scrollable") 
    }
    localStorageBackup2();
    switcherClick();
    checkOptions();
...
function switcherClick() {
    ...
    fixedGridHeaderBtn = document.querySelector('#grid-header-fixed');
    scrolGridHeaderBtn = document.querySelector('#grid-header-scroll');
    ...
    let fixedHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
    ...
    /* Grid Header-Position Styles Start */
    let fixedGridHeaderVar = fixedGridHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-grid-header-position', 'fixed');
        localStorage.setItem("ynexgridheaderfixed", true);
        localStorage.removeItem("ynexgridheaderscrollable");
    });

    let scrollGridHeaderVar = scrolGridHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-grid-header-position', 'scrollable');
        localStorage.setItem("ynexgridheaderscrollable", true);
        localStorage.removeItem("ynexgridheaderfixed");
    });
    /* Grid Header-Position Styles End */
...
function ResetAllFn() {
    ...
    html.removeAttribute('data-grid-header-position');
...
function checkOptions() {
    ...
    if (localStorage.getItem('ynexgridheaderscrollable')) {
        document.querySelector('#grid-header-scroll').checked = true;
    }
    ...
    if (localStorage.getItem('ynexgridheaderfixed')) {
        document.querySelector('#grid-header-fixed').checked = true;
    }
    //
